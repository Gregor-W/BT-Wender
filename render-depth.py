...
parser.add_argument('--grasp_outer', nargs='*', type=float)
...
s_outer_point0 = np.array([0.7473, -0.6645, -0.0093, 1]) * 0.05 + s_point
s_outer_point1 = np.array([0.7473, -0.6645, -0.0093, 1]) * -0.05 + s_point
